...
else if (!is_numeric($pst_ytd_sales_v) || $pst_ytd_sales_v <= 0)
{
	...
	echo 'Street can only contain numbers, letters, commas, and periods.';
	include('global/error.php');
}
	...
	echo 'City can only contain letters.';
	include('global/error.php');
}
	...
	echo 'State can only contain letters.';
	include('global/error.php');
}
	...
	echo 'Zip must contain 5-9 digits, and no other characters';
	include('global/error.php');
}
	...
	echo 'Phone must contain 10 digits, and no other characters';
	include('global/error.php');
}
	...
	echo 'YTD_sales must contain no more than 10 digits, including a deicmal point.';
	include('global/error.php');
}
else{
